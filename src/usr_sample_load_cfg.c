...
/*									    */
/*									    */
/* MODULE NAME : usr_sample_load_cfg.c					    */
/*									    */
/* MODULE DESCRIPTION :							    */
...
/************************************************************************/
static ST_CHAR *get_next_string (ST_CHAR **ptrptr, ST_CHAR *delimiters)
  {
ST_CHAR *curptr;
ST_CHAR *string;
...
/* safe string copy							*/
/************************************************************************/
ST_VOID strncpy_safe (char *dest, char *src, unsigned int max_len)
  {
